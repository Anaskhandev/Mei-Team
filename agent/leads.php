...
$qry = "SELECT * FROM expert WHERE claimed=0 ORDER BY id DESC";
$res = $conn->query($qry);
?>
<div class="row">
    <div class="col-md-12">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button id="claim_btn" class="btn btn-success claim_btn
                                        <?php
                                        if ($row['claimed'] === "1") {
                                            echo 'disabled';
                                        }
                                        ?>"><i class="metismenu-icon fa-solid fa-paperclip mr-2"></i>Claim</button>
