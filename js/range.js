...
$('.area-range').each(function () {
  ...
  var dataUnit2 = $(this).attr('data-unit2');
  ...
  $(this)
    .children('.first-slider-value')
    .val($(this).slider('values', 0) + ' ' + dataUnit2);
  $(this)
    .children('.second-slider-value')
...
$('.price-range').each(function () {
  ...
  $(this).slider({
    ...
    slide: function (event, ui) {
      ...
      $(this)
        .children('.first-slider-value')
        .val(dataUnit + ui.values[0].toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, '$1,'));
      $(this)
        .children('.second-slider-value')
        .val(
          dataUnit + ui.values[1].toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, '$1,') + dataUnit2
        );
    },
  });
  $(this)
