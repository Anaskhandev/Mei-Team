            ...
            var i = !1,
              s = function (n) {
                ('undefined' != typeof n && n.target != t[0]) ||
                  (i || (t.off(r.transitionend), t.off(r.webkitTransitionEnd), e.call(t[0])),
                  (i = !0));
              };
    ...
    (function (t) {
      ...
      (t[e].addons[n] = {
        ...
        (t[e].prototype._initBlocker = function () {
          var e = this;
          this.opts[n].blockUI &&
            (r.$blck || (r.$blck = t('<div id="' + i.blocker + '" class="' + i.slideout + '" />')),
            r.$blck
              .appendTo(r.$body)
    ...
    (function (t) {
      ...
      (t[e].addons[n] = {
        ...
        (t[e].prototype['_initWindow_' + n] = function () {
          ...
          r.$body
            .off(a.touchstart + '-' + n)
            .on(a.touchstart + '-' + n, '.' + i.panels + '> .' + i.panel, function (t) {
            ...
            .off(a.touchmove + '-' + n)
            .on(a.touchmove + '-' + n, '.' + i.panels + '> .' + i.panel, function (e) {
              r.$html.hasClass(i.opened) &&
              ...
              this.bind('initListview:after', function (n) {
                ...
                if (r && r.length) {
                  var o = r.children('.' + i.next),
                    ...
                    c = t[e].i18n(
                      l.text[o.parent().is('.' + i.vertical) ? 'toggleSubmenu' : 'openSubmenu']
                    );
