            ...
            <div class="col-lg-3 col-md-6 col-xs-12 dar pro mr-3">
                <div class="item">
                    ...
                    <div class="info">
                        ...
                        <p class="type ml-1">Registered Users</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-xs-12 dar rev mr-3">
                <div class="item">
                    ...
                    <div class="info">
                        ...
                        <p class="type ml-1">Total Cities</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 dar com mr-3">
                <div class="item mb-0">
                    ...
                    <div class="info">
                        ...
                        <p class="type ml-1">Neighborhood</p>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from code-theme.com/html/findhouses/dashboard.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Dec 2022 11:49:45 GMT -->
